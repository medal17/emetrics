      ...
      <main className={styles.main}>
        ...
        {/* <h1 className={styles.title}>
          ...
          <PartnerHero 
            ...
            body='Enterprise Metric Suite Solutions Limited (Ghana) is a representative of Enterprise Metric Suite Solutions LLC in Ghana. Enterprise Metric Suite Solutions LLC is a global business process and performance management solution provider with its international headquarters in DallasTexas, USA. In its expansion bid, Enterprise Metric Suite Solutions LLC acquired SPNS Consulting, a Nigeria based consulting firm with strength in business process management, performance management and enterprise transformation. As a duly registered organization in Nigeria, we are poised to partner with you towards transforming your business with the joint expertise of the team.' />
